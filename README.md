...
Evaluates Unity Catalog governance best practices across 35 checks in 5 categories.                                   
...
- Platform Setup (6 checks)
- Identity & Access (13 checks)
- Data Protection (9 checks)
- Data Quality & Observability (5 checks)
- AI & Model Governance (2 checks)                                                                                    

## Files                                                                                                              
               
- `governance_analyzer/`: Core governance check functions, registry, and dashboard deployment                         
- `governance_analysis.py`: Main notebook to run checks and deploy dashboard
